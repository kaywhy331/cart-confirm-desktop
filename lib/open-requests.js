...
function createOpenRequestStore(options = {}) {
  ...
  function add(retailer, url, context = {}) {
    ...
    const request = {
      ...
      signalOrderLimit: Number.isInteger(context.signalOrderLimit) && context.signalOrderLimit > 0 && context.signalOrderLimit <= 99
    ...
    return {
      ...
      signalOrderLimit: request.signalOrderLimit
    };
  }
