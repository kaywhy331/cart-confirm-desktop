...
(function initItemDefaults(globalScope) {
  ...
  function calculateOrderTotalCap(product = {}, allowances = DEFAULT_STORE_ORDER_ALLOWANCES) {
    ...
    return roundMoney(maxPrice * quantity + allowance);
  }
  ...
  function applyItemProfile(product = {}, profile, catalog = [], options = {}) {
    ...
    return {
      ...
      maxOrderTotal: needsOrderTotal && hasApprovedCap
        ? calculateOrderTotalCap(applied, options.storeOrderAllowances)
        : 0
    };
  }
