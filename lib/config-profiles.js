...
(() => {
  ...
  const BUILT_IN_PROFILES = Object.freeze([
    ...
    Object.freeze({
      ...
      description: "For several possible SKUs sharing a release window. It keeps the scheduled lane active for 15 minutes and paces store-wide refreshes so the fixed hourly action budget is not spent before a delayed page appears.",
      configuration: frozenConfiguration({
        fastMode: true,
        watcherIntervalSeconds: 60,
        retryIntervalSeconds: 10,
